...
class ConnectionRequestController extends Controller
{
    ...
    public function store(StoreConnectionRequestRequest $request)
    {
        ...
        $whatsappLink = $this->privacyMatching->buildPreliminaryWhatsappLink($sender, $receiver);

        return back()
            ->with('status', 'Demande envoyée.')
    ...
    public function accept(ConnectionRequest $connectionRequest)
    {
        ...
        return redirect()->route('requests.received')->with('status', 'Connexion acceptée.');
    }
    ...
    public function decline(ConnectionRequest $connectionRequest)
    {
        ...
        return redirect()->route('requests.received')->with('status', 'Demande refusée.');
    }
}
