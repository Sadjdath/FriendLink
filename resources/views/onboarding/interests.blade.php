...
<div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 max-w-lg mx-auto">
    <h1 class="text-xl font-bold mb-1">Vos centres d'intérêt</h1>
    <p class="text-sm text-slate-500 mb-6">Sélectionnez au moins 3 centres d'intérêt dans la liste.</p>
    ...
    <form method="POST" action="{{ route('onboarding.interests') }}">
        ...
        <div id="selected-preview" class="flex flex-wrap gap-2 mb-6"></div>
